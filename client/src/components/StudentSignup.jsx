  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      if (studentsSnapshot.empty) {
        setError(
          "No student record found with this email. Please contact your department to add you to the system first."
        )
        setLoading(false)
        return
      }
      ...
      if (studentData.rollNo !== rollNo.trim()) {
        setError(
          "Roll number does not match our records. Please check and try again."
        )
        setLoading(false)
        return
      }
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Create your account to access attendance and academic information
          </p>
        </div>
          ...
          <form onSubmit={handleSignup} className="space-y-6">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-gray-500">
                Use the email address registered with your department
              </p>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                  placeholder="Enter your roll number EG : AIXXXX"
                  required
                />
              </div>
              <p className="mt-1 text-xs text-gray-500">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-700 mt-1">
                    Your email and roll number must be already registered by
                    your department. Contact your department if you can't find
                    your details.
                  </p>
                </div>
              </div>
